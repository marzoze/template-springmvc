	  		...
	  		<div class="widget-content">
	  			...
	  			<div class="form-actions">
			    	<button type="button" id="btnSearchQuery" name="btnSearchQuery" class="btn btn-warning"><fmt:message key="btn.search" bundle="${com}" /></button>
			      	<button type="reset" id="btnCancelQuery" name="btnCancelQuery" class="btn"><fmt:message key="btn.cancel" bundle="${com}" /></button>
				</div>	
		    	...
		    	$("#grid").jqGrid({
					...
					gridComplete : function(){
						...
						for ( var i = 0; i < ids.length; i++) {			  							  				
							...
							var commonquery = true;
															
							if(isBranch == 'true'){
								url = '<a href="register?postrantypeid='+id+'&posnumber='+posNumber+'&commonquery='+commonquery+'\" id=\"'+id+'\"><img src="${pageContext.request.contextPath}/images/eye-icon.png" /></a>';
							}else{
								url = '<a href="registerho?postrantypeid='+id+'&posnumber='+posNumber+'&commonquery='+commonquery+'\" id=\"'+id+'\"><img src="${pageContext.request.contextPath}/images/eye-icon.png" /></a>';
							}
